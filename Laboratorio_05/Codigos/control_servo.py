...
QPushButton#homeButtonTop:hover {
    background-color: #14c28f;
}

QPushButton#emergencyButtonTop {
...
QPushButton#emergencyButtonTop:hover {
...
class ModernPincherGUI(QMainWindow):
    ...
    def create_manual_control_page(self):
        ...
        for i, motor_id in enumerate(self.controller.dxl_ids):
            ...
            motor_card.setMinimumHeight(90)
            motor_card.setMaximumHeight(115)
            ...
            row = i // 2
            col = i % 2
            grid.addWidget(motor_card, row, col)
    ...
    def create_fixed_values_page(self):
        ...
        for i, motor_id in enumerate(self.controller.dxl_ids):
            ...
            motor_title = QLabel(f"Motor {motor_id}")
            motor_title.setObjectName("motorLabel")
            motor_title.setMinimumWidth(90)
            motor_layout.addWidget(motor_title)
    ...
    def create_fixed_angles_page(self):
        ...
        for i, (name, angles, desc) in enumerate(presets):
            ...
            angles_label.setStyleSheet("color: #00d9ff; font-weight: bold; padding: 8px; font-size: 10pt;")
    ...
    def create_xyz_page(self):
        ...
        for label_text, default_val, attr_name in [
            ("X (m)", "0.200", "x_entry"),
            ("Y (m)", "0.000", "y_entry"),
            ("Z (m)", "0.100", "z_entry"),
        ]:
        ...
        move_btn.setStyleSheet("font-size: 12pt;")
        move_btn.clicked.connect(self.move_to_xyz_target)
        target_layout.addWidget(move_btn)

        top_grid.addWidget(current_card, 0, 0)
        top_grid.addWidget(target_card, 0, 1)

        layout.addLayout(top_grid)

        # ---- Resto igual que antes (presets + status) ----
        presets_card = QFrame()
    ...
    def create_info_page(self):
        ...
        title = QLabel("Información del Lab")
        title.setObjectName("pageTitle")
        layout.addWidget(title)
        ...
        name1 = QLabel("Nombres")
        name1.setObjectName("sectionTitle")
        layout1.addWidget(name1)
        
        info1 = QLabel("David Santiago Cuellar Lopez \nBrayan Yesid Santos Gonzales \nSergio Avellaneda Piñeros")
        info1.setStyleSheet("color: #1f1f1f; line-height: 1.8; padding: 14px;")
...
# ============================================================
#  GUI alternativa: navegación superior
# ============================================================
class Aurora1304GUI(ModernPincherGUI):
    """
    GUI compacta fija para 1304x712.
    Mantiene TODAS las funciones porque reutiliza los create_*_page()
    y los métodos de control de ModernPincherGUI.
    """

    def init_ui(self):
        self.setWindowTitle("PhantomX Pincher • Aurora 1304")

        # Tamaño fijo exacto
        self.setFixedSize(1304, 712)
        ...
        # Barra superior con tabs (sin sidebar)
    ...
    def create_topbar(self):
        ...
        bar.setFixedHeight(60)  # un poco más compacto que tu versión actual
        ...
        brand_title = QLabel("PINCHER")
        brand_title.setObjectName("brandTitle")
        brand_sub = QLabel("Aurora Control Studio")
        ...
        # Acciones rápidas
        home_btn = QPushButton("HOME (0°)")
        home_btn.setObjectName("homeButtonTop")
        home_btn.clicked.connect(self.home_all)

        emergency_btn = QPushButton("EMERGENCIA")
        emergency_btn.setObjectName("emergencyButtonTop")
        emergency_btn.clicked.connect(self.emergency_stop)
        ...
        v = QLabel("1304×712")
        v.setStyleSheet("color: #9aa7bd; font-size: 9pt; padding-right: 2px;")
        layout.addWidget(v)
    ...
    def create_pages(self):
        ...
        self.stack.addWidget(self.create_xyz_page())              # 1
        self.stack.addWidget(self.create_manual_control_page())   # 2
        self.stack.addWidget(self.create_fixed_angles_page())     # 3
        self.stack.addWidget(self.create_fixed_values_page())     # 4
        self.stack.addWidget(self.create_visualization_page())    # 5
        self.stack.addWidget(self.create_info_page())             # 6
...
def main(args=None):
    ...
    app.setStyleSheet(AURORA_STYLESHEET)
    
    try:
        gui = Aurora1304GUI(controller)
        gui.show()
        sys.exit(app.exec_())
